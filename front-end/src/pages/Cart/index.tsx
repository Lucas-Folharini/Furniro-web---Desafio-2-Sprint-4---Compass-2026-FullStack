...
export function Cart() {
  ...
  return (
    ...
    <div className="w-full bg-white flex flex-col items-center pt-10 pb-20">
      <div className="w-full max-w-[1240px] px-5 lg:px-0">
        
        {/* Título da Página */}
        <div className="mb-10 text-center lg:text-left">
          <h2 className="font-poppins font-bold text-[32px] text-[#333333]">Shopping Cart</h2>
        </div>

        {items.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 bg-[#F9F1E7] rounded-lg mb-16">
            <p className="font-poppins text-xl text-[#333333] mb-6">Your cart is empty</p>
            <Link to="/shop">
              <button className="bg-[#B88E2F] text-white font-poppins font-semibold py-3 px-10 hover:bg-[#A07A25] transition-colors">
                Return to Shop
              </button>
            </Link>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            {/* CART TOTALS*/}
            <div className="w-full max-h-[400px] lg:w-[393px] bg-[#F9F1E7] px-[75px] pt-[15px] pb-[80px] flex flex-col items-center">
              <h2 className="font-poppins font-semibold text-[32px] text-[#000000] mb-[60px]">
                Cart Totals
              </h2>
